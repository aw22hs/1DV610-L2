...
describe('WordValidator', () => {
  ...
  describe('constructor', () => {
    ...
    test('should throw an error for empty input', () => {
      expect(() => new WordValidator()).toThrowError('Invalid input. The submitted word is empty.')
    })

    test('should throw an error for null input', () => {
      expect(() => new WordValidator(null)).toThrowError('Invalid input. The submitted word is empty.')
    })
